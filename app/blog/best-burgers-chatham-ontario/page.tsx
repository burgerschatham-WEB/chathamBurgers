    ...
    >
      ...
      >
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            Best Burgers in{" "}
            <span style={{ color: "#F5C518" }}>Chatham Ontario</span>
            <br />
            (2026 Guide)
          </h1>
          <p
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <section style={{ marginBottom: "48px" }}>
          ...
          <ul style={listStyle}>
            <li style={listItem}>
              <strong style={{ color: "#F5C518" }}>The meat.</strong> Fresh local farm beef, delivered daily. You can taste the difference between fresh and frozen — the texture, the flavour, the way it holds together on the flame.
            </li>
            <li style={listItem}>
              <strong style={{ color: "#F5C518" }}>The patty quality.</strong> Fresh beef, properly
              seasoned, at the right fat ratio. Pre-frozen patties are immediately obvious in the
              texture and taste.
            </li>
            <li style={listItem}>
              <strong style={{ color: "#F5C518" }}>The fries.</strong> A great burger is undermined by
              sad fries. Fresh-cut, properly fried — it matters.
            </li>
            <li style={listItem}>
              <strong style={{ color: "#F5C518" }}>Consistency.</strong> A burger that's great once
        ...
        <section style={{ marginBottom: "48px" }}>
          ...
          >
            ...
            <Link href="/order" style={{ color: "#F5C518", textDecoration: "none" }}>
