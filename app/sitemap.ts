...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: 'https://chathamburgers.ca/blog/smash-burger-chatham-ontario', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: 'https://chathamburgers.ca/blog/history-of-burgers', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
  ]
}
